...
class _Segmentation(nn.Module):
    ...
    def forward(self, x, mu_t_f1=0, std_t_f1=0, transfer=False, mix=False, activation=None):
        ...
        features = {}
        features['low_level'] = self.backbone(x, trunc1=False, trunc2=False, trunc3=False, trunc4=False,
        ...
        if transfer:
            ...
            features_low_norm = (features['low_level'] - mean.expand(self.size)) / std.expand(self.size)
